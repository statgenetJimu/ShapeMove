...
namespace DDG
{
   ...
   {
      Application app;
      //app.run(step, mesh, meshS);
      //app.run(step,mesh,meshY);
      app.run(step,mesh,meshY,meshS);
      //app.run(step, mesh);
      updateDisplayList();
   }
